...
CREATE TABLE public.users (
    ...
    storage character varying(1024)
);
...
COPY public.users (id, name, email, username, registered_at, role_id, hashed_password, is_active, is_superuser, is_verified, storage) FROM stdin;
\.
